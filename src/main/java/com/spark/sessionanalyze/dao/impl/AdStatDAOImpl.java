...
import com.spark.sessionanalyze.dao.IAdStatDAO;
import com.spark.sessionanalyze.domain.AdStat;
import com.spark.sessionanalyze.jdbc.JDBCHelper;
import com.spark.sessionanalyze.model.AdStatQueryResult;
...
public class AdStatDAOImpl implements IAdStatDAO {
	...
	public void updateBatch(List<AdStat> adStats) {
		...
		// 对于需要更新的数据，执行批量更新操作
		String updateSQL = 
				"UPDATE ad_stat SET click_count=? "
//				+ "FROM ad_stat "
				+ "WHERE date=? "
				+ "AND province=? "
				+ "AND city=? "
